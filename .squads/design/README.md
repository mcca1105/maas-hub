...
**Version:** 4.0.0 (AIOX Conformant)
**Type:** Specialist Squad
**Independence:** ✅ 100% Self-Contained
**AIOX Level:** L4 (Project Runtime)
**Standardized:** 2026-03-14

---

## Overview

The Design Squad is a **complete team of 10 expert agents** covering all aspects of visual design:
...
- **Premium Theme Design** - Dark premium experience transformation
...
| **Premium Design** | `@premium-design` | Dark Premium Theme, UX Transformation |
...
```
.squads/design/
├── agents/                   # 10 expert personas
│   ├── design-chief.md       # Orchestrator (983 lines)
│   ├── marty-neumeier.md     # Brand Strategy (1,542 lines) [Tier 0]
│   ├── dave-malouf.md        # DesignOps (2,270 lines) [Tier 0]
│   ├── chris-do.md           # Design Business (1,866 lines) [Tier 1]
│   ├── paddy-galloway.md     # Thumbnails (1,966 lines) [Tier 1]
│   ├── joe-mcnally.md        # Photography (1,634 lines) [Tier 1]
│   ├── brad-frost.md         # Design Systems (832 lines) [Tier 2]
│   ├── aaron-draplin.md      # Logo Design (1,721 lines) [Tier 2]
│   ├── peter-mckinnon.md     # Photo Editing (1,903 lines) [Tier 2]
│   └── premium-design.md     # Dark Premium Theme [Tier 2]
├── tasks/                    # 67 design tasks
├── templates/                # 13 templates
├── checklists/               # 11+ quality checklists
├── data/                     # 9 knowledge base files
├── workflows/                # 4 workflow orchestrations
├── squad.yaml                # AIOX configuration
├── MEMORY.md                 # Squad memory & history
└── README.md                 # This file
```

**AIOX Conformance:** L4 (Project Runtime) ✅
**Standardization Date:** 2026-03-14
...
**Version:** 4.0.0 (AIOX v4.31.1 Conformant)
**Maintained By:** Design Squad Contributors
**Last Updated:** 2026-03-14 (AIOX Standardization)
**Total Agents:** 10 expert personas
**Independence:** ✅ 100% Self-Contained
